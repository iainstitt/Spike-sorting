...
ops.fbinary             = fullfile(fpath, 'rawData.dat'); % will be created for 'openEphys'		
ops.fproc               = fullfile(fpath, 'temp_wh.dat'); % residual from RAM of preprocessed data		
ops.root                = fpath; % 'openEphys' only: where raw files are		
% define the channel map as a filename (string) or simply an array		
ops.chanMap             = fullfile(fpath, 'cortex_2x8_Map.mat'); % make this file using createChannelMapFile.m		
