% This function is exactly the same as the original 'preprocessData.m' from
% the kilosort package. The only thing I have chanheg is the filter order
% to 4 (instaed of 2). 

function [rez, DATA, uproj] = is_preprocessData(ops)
tic;
uproj = [];
...
if isfield(ops,'fslow')&&ops.fslow<ops.fs/2
    [b1, a1] = butter(4, [ops.fshigh/ops.fs,ops.fslow/ops.fs]*2, 'bandpass');
else
    [b1, a1] = butter(4, ops.fshigh/ops.fs*2, 'high');
end
