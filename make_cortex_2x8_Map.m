function make_cortex_2x8_Map(fpath)
...
chanMap = [12 13 14 15 16 17 18 19 11 10 9 8 23 22 21 20] - 7;
...
xcoords = [0 200 400 600 800 1000 1200 1400 0 200 400 600 800 1000 1200 1400];
ycoords = [0 0 0 0 0 0 0 0 200 200 200 200 200 200 200 200  ];
...
save(fullfile(fpath, 'cortex_2x8_Map.mat'), 'chanMap', 'connected', 'xcoords', 'ycoords', 'kcoords', 'fs')